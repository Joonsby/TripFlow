...
export const headerMessages = {
  ko: {
    ...
    userMenu: '사용자 메뉴', myPage: '마이페이지', hostMode: '호스트 모드로 전환', reservations: '예약 내역', wishlist: '찜한 숙소', trips: '여행 일정', logout: '로그아웃', loggingOut: '로그아웃 중...',
  ...
  en: {
    ...
    userMenu: 'User menu', myPage: 'My page', hostMode: 'Switch to host mode', reservations: 'Reservations', wishlist: 'Wishlist', trips: 'Trips', logout: 'Log out', loggingOut: 'Logging out...',
  ...
  ja: {
    ...
    userMenu: 'ユーザーメニュー', myPage: 'マイページ', hostMode: 'ホストモードに切り替え', reservations: '予約履歴', wishlist: 'お気に入り', trips: '旅行日程', logout: 'ログアウト', loggingOut: 'ログアウト中...',
  ...
  zh: {
    ...
    userMenu: '用户菜单', myPage: '我的主页', hostMode: '切换到房东模式', reservations: '预订记录', wishlist: '收藏住宿', trips: '旅行计划', logout: '退出登录', loggingOut: '正在退出...',
