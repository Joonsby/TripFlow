...
export const headerMessages = {
  ko: {
    ...
    userMenu: '사용자 메뉴', myPage: '마이페이지', reservations: '예약 내역', wishlist: '찜한 숙소', trips: '여행 일정', logout: '로그아웃', loggingOut: '로그아웃 중...',
  ...
  en: {
    ...
    userMenu: 'User menu', myPage: 'My page', reservations: 'Reservations', wishlist: 'Wishlist', trips: 'Trips', logout: 'Log out', loggingOut: 'Logging out...',
  ...
  ja: {
    ...
    userMenu: 'ユーザーメニュー', myPage: 'マイページ', reservations: '予約履歴', wishlist: 'お気に入り', trips: '旅行日程', logout: 'ログアウト', loggingOut: 'ログアウト中...',
  ...
  zh: {
    ...
    userMenu: '用户菜单', myPage: '我的主页', reservations: '预订记录', wishlist: '收藏住宿', trips: '旅行计划', logout: '退出登录', loggingOut: '正在退出...',
